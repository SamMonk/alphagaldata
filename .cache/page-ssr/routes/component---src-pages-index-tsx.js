...
function HeatMap() {
  ...
  (0,react__WEBPACK_IMPORTED_MODULE_0__.useEffect)(() => {
    (async () => {
      await __webpack_require__.e(/*! import() */ "node_modules_leaflet_dist_leaflet-src_js").then(__webpack_require__.t.bind(__webpack_require__, /*! leaflet */ "./node_modules/leaflet/dist/leaflet-src.js", 23));
      ...
      const data = await __webpack_require__.e(/*! import() */ "src_data_lone_star_ticks_sample_json").then(__webpack_require__.t.bind(__webpack_require__, /*! ../data/lone_star_ticks.sample.json */ "./src/data/lone_star_ticks.sample.json", 19));
      const MapInner = () => {
        const map = useMap();
