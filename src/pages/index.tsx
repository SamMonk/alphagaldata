...
const organizationJsonLd = {
  ...
  '@type': 'Organization',
  name: 'AlphaGalData',
  url: 'https://alphagaldata.com',
  description: 'Safe recipes, ingredient scanner, tick heat maps, and evidence-based guides for people living with alpha-gal syndrome (AGS).',
};
...
export function Head() {
  const title = 'AlphaGalData — Recipes, Tools, and Guides for Alpha-Gal Syndrome';
  const description = 'Safe recipes, ingredient scanner, tick heat maps, and evidence-based guides for people living with alpha-gal syndrome (AGS).';
  const url = 'https://alphagaldata.com';
